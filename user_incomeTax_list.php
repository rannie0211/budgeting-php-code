...
if(is_object($result))
{
    if($result->num_rows > 0)
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $sql2 = "SELECT * from transaction where trans_user_id = '".$user_id."' and trans_category = '".$category."' and trans_status = 0 and trans_income_tax = 1 and trans_type = '".$type."' and YEAR(trans_date) = '".$year."'";
